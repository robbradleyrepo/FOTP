...
import SUPP_IMG from "../../assets/images/collections/supp-block.jpg";
import HERO_DESKTOP_IMG from "../../assets/images/collections/treats-hero-desktop.jpg";
import HERO_MOB_IMG from "../../assets/images/collections/treats-hero-mob.jpg";
import HERO_TABLET_IMG from "../../assets/images/collections/treats-hero-tablet.jpg";
import OG_IMG from "../../assets/images/collections/treats-og.jpg";
...
const enUsResource = {
  ...
  supplements: {
    ...
    title: "Give Your Bestie A Natural Boost With Our Supplements",
  },
};

interface TreatsPageProps {
  data: CollectionData;
}

const TreatsPage: NextPageWithApollo<TreatsPageProps> = ({ data }) => {
  const { i18n, t } = useLocale();

  i18n.addResourceBundle("en-US", "treats", enUsResource);
  ...
  return (
    <Standard>
      <Metadata
        ...
        title={t("treats:meta.title", { title })}
        openGraph={{
          description: description,
          image: OG_IMG.src,
          title: t("treats:meta.title", { title }),
